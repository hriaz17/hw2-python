...
`https://github.com/CSC483-583-Spring-2024/hw2-python-<your-username>`, where
...
just created. Your command must be similar to :
   ```
   git clone -b <branch> https://github.com/CSC483-583-Spring-2024/hw2-python-<your-username>.git
   ```

# Write your code

You will implement one function each for each of the sub questions of question 8, Eg:` def q8_1_1(self,query):` inside 
...
**Note: The file `Docs.txt` is the input file you must use as per Homework 2 guidelines. Please don't edit it or move it.**

# Test your code

Tests have been provided for you in the `test_hw2_q8.py` file.
...
The programming question of this assignment will be graded primarily on their ability to pass the tests that have been provided to you on GitHub after the pull request.
